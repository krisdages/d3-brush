...
function brush$1(dim) {
  ...
  function started() {
    ...
    var that = this,
        ...
        mode = (eventModMatches(d3Selection.event, modForceNew) ? type = "overlay" : type) === "selection" ? MODE_DRAG : (eventModMatches(d3Selection.event, modFixCenter) ? MODE_CENTER : MODE_HANDLE),
        ...
        dy,
        moving,
        shifting = signX && signY && eventModMatches(d3Selection.event, modFixSecondary),
        alting = eventModMatches(d3Selection.event, modFixCenter),
        lockX,
        lockY,
    ...
    function keyupped() {
      switch (d3Selection.event.keyCode) {
        ...
        case modFixSize._keyCode: { // SPACE
          if (mode === MODE_SPACE) {
            if (eventModMatches(d3Selection.event, modFixCenter) || alting) {
              if (signX) e0 = e1 - dx * signX, w0 = w1 + dx * signX;
              if (signY) s0 = s1 - dy * signY, n0 = n1 + dy * signY;
              mode = MODE_CENTER;
            } else {
...
exports.brushForceNew = brushForceNew;
exports.brushFixSize = brushFixSize;
exports.brushFixCenter = brushFixCenter;
exports.brushFixSecondary = brushFixSecondary;
